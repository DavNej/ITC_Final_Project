...
urlpatterns = [
    ...
    url(r'^gallery_kid/$', gallery_kid, name='gallery_kid'),
    url(r'^gallery_class/$', gallery_class, name='gallery_class'),
    url(r'^gallery_schools/$', gallery_schools, name='gallery_schools'),
